...
data_type
    ...
    | 'UUID'
    | 'SERIAL' | 'BIGSERIAL'
    | identifier  // Kullanıcı tanımlı tipler
    ;
...
// Anahtar kelimeler (sadece bazıları)
keyword
...
// Tanınmayan karakterler için hata
UNKNOWN_CHAR: .